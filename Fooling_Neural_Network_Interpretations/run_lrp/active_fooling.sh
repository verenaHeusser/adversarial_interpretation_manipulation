...
FIXED_OPTION='--loss_type active --batch-size 4 --batch-size_test 4 --num_visualize_plot 16 --imagenet_accuracy --c1_c2_accuracy --num_eval 4 --eval-period 1000 --class_c1 n02091635 --class_c2 n02808440'
