...
\cite{evaluating_explanations_security} propose two major categories for Model-agnostic strategies, namely \textit{black-box}, in the following named \textit{model-agnostic} methods and \textit{white-box}, or \textit{} explanation methods. 
