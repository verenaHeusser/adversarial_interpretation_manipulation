...
Institute of Technology (KIT), Intelligent System Security Research Group}{2020}
\acmDOI{}
\acmISBN{}
...
Note that defining similarities that are similar to human vision is still an active area of research. \section{Manipulation Methods}
